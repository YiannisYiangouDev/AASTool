  ...
  return (
    <div className="min-h-screen bg-[#030712] text-white selection:bg-teal-500/30">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-indigo-500/[0.03] rounded-full blur-[150px]" />
      </div>
      ...
      <main id="main-content" className="relative z-10 px-4 sm:px-6 lg:px-8 py-16 max-w-7xl mx-auto pt-28 pb-28">
        ...
        <div className="text-center mb-20">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black tracking-tight leading-[1.05]">
            Assessment <span className="bg-gradient-to-r from-teal-400 via-blue-400 to-indigo-400 bg-clip-text text-transparent">Dimensions</span>
          </h1>
          <p className="text-slate-400 mt-5 text-lg max-w-2xl mx-auto leading-relaxed">
            The five pillars of inclusive building evaluation. Each dimension groups criteria that assess a specific facet of accessibility.
          </p>
        ...
        {!isLoading && !error && (
          <div className="mt-20 text-center">
            <div className="inline-flex flex-col items-center gap-4 p-8 sm:p-12 rounded-3xl border border-white/[0.06] bg-white/[0.02] backdrop-blur-sm max-w-2xl w-full">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-teal-500/20 to-indigo-500/20 ring-1 ring-teal-500/30">
              ...
              <h2 className="text-2xl font-bold text-white">Ready to certify?</h2>
              <p className="text-slate-400 text-sm max-w-md">
                Score criteria across all five dimensions and generate a comprehensive accessibility certification.
              </p>
              <Link
                href="/certification"
                className="inline-flex items-center gap-3 px-8 py-3.5 rounded-full bg-gradient-to-r from-teal-500 to-indigo-500 text-white font-semibold text-sm hover:from-teal-400 hover:to-indigo-400 hover:shadow-lg hover:shadow-teal-500/25 transition-all duration-300 hover:scale-[1.03] active:scale-95"
              >
                Open Certification
